...
### 3.b
Оновити логіку створення замовлення таким чином, що б користувачу у відповідь надсилав не тільки стоврене замовлення, але і поле distance яке вираховуються на основі координат і повертається у форматі кілометрів
//тобто координати ми вже маємо і тепер потрібно присвоїти полю конвертування координат у кілометри
